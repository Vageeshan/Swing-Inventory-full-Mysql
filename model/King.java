...
public class King {
    ...
    public King(int customer_id, String first_name, String last_name, String address, int bussinuss_contact, int personal_contact, String email_address, String created_by, String created_date) {
